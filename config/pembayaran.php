...
//get id_pembelian 
$idpem = $_GET["id"];
$ambil = $conn->query("SELECT * FROM pemesanan WHERE id_pembelian='$idpem'");
...
<body style="font-family: monospace;">
	...
	if (isset($_POST["kirim"])) {
		...
		move_uploaded_file($lokasibukti, "../assets/bukti_pembayaran/$namafix");

		$nama = $_POST["nama"];
		$tanggal = date("Y-m-d");

		//simpan pembayaran
		$conn->query("INSERT INTO pembayaran(id_pembelian, nama, tanggal, bukti)
		VALUES ('$idpem', '$nama', '$tanggal','$namafix') ");

		//update database pemesanan
		$conn->query("UPDATE pemesanan SET status_pemesanan='Bukti pembayaran terkirim'
