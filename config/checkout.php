	...
	<section class="konten">
		<div class="container">
			...
			if (isset($_POST["checkout"])) {
				...
				$conn->query("INSERT INTO pemesanan (id_pelanggan, id_ongkir, tanggal_pemesanan, total_pemesanan, nama_kota, alamat_pengiriman)
					VALUES ('$id_pelanggan', '$id_ongkir', '$tanggal_pemesanan', '$total_pemesanan', '$nama_kota', '$alamat_pengiriman') ");
				...
				foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) {
					...
					$conn->query("INSERT INTO pemesanan_produk (id_pembelian, id_produk, nama, harga, subharga, jumlah) 
